...
<div class="container text-center">
    ...
    <h1>Contact Us</h1>
                    ...
                    <br>        New Delhi,Delhi 110034 
                    <br>
                    <abbr title="Phone"><span style="font-weight:bold">Phone:</span></abbr>(011) 22384165<br>
                    <abbr title="Timings"><span style="font-weight:bold">Timings:</span></abbr> 9AM-8PM 
                    <br>
                    <abbr title="Email"><span style="font-weight:bold">Email id:</span></abbr> <a href="mailto:#">bookstore.in@gmail.com</a><br><br>
                    <span style="font-weight:bold">FOLLOW US ON.....</span><br>
